...
#ifndef TINDER_SWIFT_H
#define TINDER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="tinder",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6tinder11AppDelegate")
...
SWIFT_CLASS("_TtC6tinder15CombineCardView")
@interface CombineCardView : UIView
...
SWIFT_CLASS("_TtC6tinder21CombineViewController")
...
@interface CombineViewController (SWIFT_EXTENSION(tinder))
- (void)cardHandlerWithGesture:(UIPanGestureRecognizer * _Nonnull)gesture;
- (void)onPressDislike;
- (void)onPressLike;
- (void)onPressSuperlike;
@end


SWIFT_CLASS("_TtC6tinder7Loading")
...
SWIFT_CLASS("_TtC6tinder13SceneDelegate")
...
SWIFT_CLASS("_TtC6tinder14ViewController")
